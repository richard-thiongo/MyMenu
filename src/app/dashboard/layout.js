      ...
      <div className="flex min-h-screen flex-col md:flex-row bg-surface text-text">
            ...
            <div>
              ...
              <nav className="flex flex-col gap-2">
                ...
                <div className="relative">
                  ...
                  {/* Desktop Tooltip */}
                  {showTooltip && (
                    <div className={`absolute z-[60] animate-in slide-in-from-left-4 fade-in duration-300 w-64 rounded-2xl bg-blue-50 dark:bg-blue-900/40 p-4 shadow-[0_0_40px_rgba(0,0,0,0.15)] border border-black/10 dark:border-white/10 pointer-events-auto ${isCollapsed ? 'left-20 top-0' : 'left-full ml-4 top-0'}`}>
                      {/* Caret pointing left */}
                      <div className="absolute top-4 -left-2 h-4 w-4 rotate-45 border-b border-l border-black/10 dark:border-white/10 bg-blue-50 dark:bg-blue-900/40"></div>
        ...
        <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 flex items-center justify-around border-t border-border bg-surface/90 pb-[max(env(safe-area-inset-bottom),0.5rem)] pt-2 backdrop-blur-md shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
          ...
          <div className="relative flex flex-col items-center">
            ...
            {/* Mobile Tooltip */}
            {showTooltip && (
              <div className="absolute bottom-16 left-1/2 -translate-x-1/2 z-[60] animate-in slide-in-from-bottom-4 fade-in duration-300 w-64 rounded-2xl bg-blue-50 dark:bg-blue-900/40 p-4 shadow-[0_0_40px_rgba(0,0,0,0.15)] border border-black/10 dark:border-white/10 pointer-events-auto">
                {/* Caret pointing down */}
                <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 h-4 w-4 rotate-45 border-b border-r border-black/10 dark:border-white/10 bg-blue-50 dark:bg-blue-900/40"></div>
